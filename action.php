<?php
    ...
    if (isset($_POST['submit1'])){
        ...
        if (move_uploaded_file($_FILES['userfile']['tmp_name'], $uploadir.$uploadfile)){
            echo "File telah diupload";
        } else {
            echo"file gagal diupload";
        }
        // session upload file ke db
    ...
    <?php
        ...
        if ($_SESSION['lives'] == 0){
            ...
            $query = "INSERT INTO score(username, score, playtime, foto)
                VALUES('".S_COOKIE['username']."','".$_SESSION['score']."','".date('Y-m-d H:i:s')."','".$_SESSION['filenameupload']."')";
            //jalankan query
